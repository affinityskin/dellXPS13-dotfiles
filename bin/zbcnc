...
#
#	Location:		/usr/local/bin/zb-install
#
########################################################################
...
setup_sources() {
	...
	deb http://au.archive.ubuntu.com/ubuntu/ xenial main contrib non-free
	deb-src http://httpredir.debian.org/debian/ stretch main contrib non-free

	deb http://au.archive.ubuntu.com/ubuntu/ xenial-updates main contrib non-free
	deb-src http://au.archive.ubuntu.com/ubuntu/ xenial-updates main contrib non-free
	...
	deb http://repo.linrunner.de/debian  stable main
	EOF
...
get_dotfiles() {
	...
	git clone git@github.com:affinityskin/dotfiles.git "/home/$USERNAME/dotfiles"
